...
1. 点击左侧菜单栏的"选择文档库位置"按钮
2. 选择您想要使用的 Markdown 文档所在的文件夹
3. 选择完成后，系统会自动加载该文件夹下的所有 Markdown 文档
...
- 点击文件夹可以展开/折叠子目录
- 点击 Markdown 文件可以在右侧查看内容
- 支持图片、表格、代码块等 Markdown 语法
- 自动保存上次打开的文档库位置

## 注意事项

- 请确保选择的文件夹中包含 Markdown 文件（.md 后缀）
- 建议使用 UTF-8 编码的 Markdown 文件
